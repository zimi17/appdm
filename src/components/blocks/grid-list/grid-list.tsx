...
export function GridList({ title, items, className, titleClassName, hrClassName, cardClassName }: { title?: string, items: any[], className?: string, titleClassName?: string, hrClassName?:string, cardClassName?: string }) {
  return (
    <motion.section 
