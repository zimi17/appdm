...
export function MissionTopper({ titleParts, slides }: MissionTopperProps) {
  ...
  return (
    <section className="bg-card text-card-foreground" data-theme="dark" data-region="topper-mission">
      <div className="mission-topper__content">
        <h1 className="sr-only">STIE Dwimulya</h1>
        
        <div className="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-16 gap-x-6 px-6">
          <div className="col-span-full py-12 md:py-16">
            <div className="max-w-5xl">
              <div className="font-headline text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
        ...
        <div className="mission-topper__media relative w-full">
            <Carousel
                setApi={setApi}
