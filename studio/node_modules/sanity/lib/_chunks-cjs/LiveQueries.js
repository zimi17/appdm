...
function LiveQueries(props) {
  ...
  let t8;
  return $[20] !== client || $[21] !== comlink$1 || $[22] !== dataset || $[23] !== liveDocument || $[24] !== liveEvents || $[25] !== projectId || $[26] !== t7 ? (t8 = /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: t7.map((t9) => {
    const [key, t10] = t9, {
      query,
      params,
      perspective
  ...
  }) }), $[20] = client, $[21] = comlink$1, $[22] = dataset, $[23] = liveDocument, $[24] = liveEvents, $[25] = projectId, $[26] = t7, $[27] = t8) : t8 = $[27], t8;
}
function _temp() {
}
