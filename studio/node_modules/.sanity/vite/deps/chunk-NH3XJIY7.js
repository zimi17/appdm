...
var presentationUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources7-64PFE4AU.js")
});
var INITIAL_STATE = {
  locations: []
};
...
var LocationStack = dt.div((props) => {
...
function PresentationDocumentHeader(props) {
  ...
  if ($[5] !== contextOptions || $[6] !== documentId || $[7] !== resolvers || $[8] !== schemaType2 || $[9] !== version) {
    ...
    t2 = $[10];
  let t3;
  return $[17] !== t2 ? (t3 = (0, import_jsx_runtime.jsx)(LocationStack, { children: t2 }), $[17] = t2, $[18] = t3) : t3 = $[18], t3;
}
function _temp$1(o) {
  var _a;
...
var PresentationTool = (0, import_react.lazy)(() => import("./PresentationToolGrantsCheck-M2V6CRLD.js"));
var BroadcastDisplayedDocument = (0, import_react.lazy)(() => import("./BroadcastDisplayedDocument-QP3OLBTI.js"));
...
//# sourceMappingURL=chunk-NH3XJIY7.js.map
