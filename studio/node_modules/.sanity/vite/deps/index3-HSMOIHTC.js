import {
  ...
  usePaneLayout,
  useStructureTool
} from "./chunk-UL2KDBOG.js";
import "./chunk-AUMNA6LV.js";
import {
  Button,
  ErrorBoundary,
  NEVER,
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-62HUVSAT.js")),
  document: (0, import_react.lazy)(() => import("./pane-XA3C3SVV.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-XA3C3SVV.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-GB3JRQRG.js"))
};
...
//# sourceMappingURL=index3-HSMOIHTC.js.map
