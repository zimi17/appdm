...
// node_modules/sanity/lib/_chunks-es/PostMessageSchema.mjs
...
var SchemaIcon = function(t0) {
  ...
  let t1;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t1 = new vt(), $[0] = t1) : t1 = $[0];
  const sheet = t1, Icon = schemaType.icon;
  let t2;
  return $[1] !== Icon || $[2] !== scheme || $[3] !== theme || $[4] !== tone ? (t2 = Icon ? (0, import_jsx_runtime.jsx)(Ye, { sheet: sheet.instance, children: (0, import_jsx_runtime.jsx)(ThemeProvider, { theme, scheme, tone, children: (0, import_react.isValidElement)(Icon) ? Icon : (0, import_jsx_runtime.jsx)(Icon, {}) }) }) : null, $[1] = Icon, $[2] = scheme, $[3] = theme, $[4] = tone, $[5] = t2) : t2 = $[5], t2;
};
...
function extractSchema(workspace, theme) {
  ...
  function extractIcon(schemaType) {
    if (schemaType.icon)
      return (0, import_server.renderToString)((0, import_jsx_runtime.jsx)(SchemaIcon, { schemaType, theme }));
  }
...
function PostMessageSchema(props) {
  ...
  }, t1 = [comlink, theme, workspace], $[0] = comlink, $[1] = theme, $[2] = workspace, $[3] = t0, $[4] = t1) : (t0 = $[3], t1 = $[4]), (0, import_react.useEffect)(t0, t1);
  let t2;
  ...
  }), t4 = [comlink, client, perspective], $[7] = client, $[8] = comlink, $[9] = perspective, $[10] = t3, $[11] = t4) : (t3 = $[10], t4 = $[11]), (0, import_react.useEffect)(t3, t4), null;
}
function _temp2(t0) {
  const {
    path: path_1,
...
var PostMessageSchema$1 = (0, import_react.memo)(PostMessageSchema);
export {
  PostMessageSchema$1 as default
};
//# sourceMappingURL=PostMessageSchema-TZKEXY4I.js.map
