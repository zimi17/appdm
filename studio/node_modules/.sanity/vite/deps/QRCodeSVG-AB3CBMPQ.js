...
// node_modules/sanity/lib/_chunks-es/QRCodeSVG.mjs
...
function useQRCode({
  ...
  const qrcode = (0, import_react.useMemo)(() => {
...
function QRCodeSVGComponent(props) {
  const {
    ...
    logoSize,
    size
  }), cellsToDraw = (0, import_react.useMemo)(() => logoSize && (calculatedImageSettings == null ? void 0 : calculatedImageSettings.excavation) ? excavateModules(cells, calculatedImageSettings.excavation) : cells, [calculatedImageSettings == null ? void 0 : calculatedImageSettings.excavation, cells, logoSize]), fgPath = generatePath(cellsToDraw, margin);
  return (0, import_jsx_runtime.jsxs)("svg", { height: size, width: size, viewBox: `0 0 ${numCells} ${numCells}`, role: "img", children: [
    !!title && (0, import_jsx_runtime.jsx)("title", { children: title }),
    (0, import_jsx_runtime.jsx)(motion.path, { fill: color, d: fgPath, shapeRendering: "crispEdges", initial: {
      opacity: 0
    }, animate: {
      opacity: 2
    }, exit: {
...
var QRCodeSVG = (0, import_react.memo)(QRCodeSVGComponent);
...
sanity/lib/_chunks-es/QRCodeSVG.mjs:
  (**
   ...
   *)
*/
//# sourceMappingURL=QRCodeSVG-AB3CBMPQ.js.map
