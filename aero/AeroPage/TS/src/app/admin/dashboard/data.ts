...
import { OrderType, PerformerType, StatisticType, sourceType } from './types'
...
const statisticChart1: ApexOptions = {
...
const statisticChart2: ApexOptions = {
...
const statisticChart3: ApexOptions = {
